python examples/dqn/cartpole-gorila.py --rank 0 --world-size 8 --node-type ps --output models/gorila.pth --memory-rank 1 --actors 2 3 4 --learners 5 6 7 --no-cuda &
...
python examples/dqn/cartpole-gorila.py --rank 4 --world-size 8 --node-type actor --ps-rank 0 --memory-rank 1 --cuda &
